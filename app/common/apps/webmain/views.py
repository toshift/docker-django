...
#        raise Http404("Question does not exist")
    ...
    return render(request, 'webmain/detail.html', {'question':question})

def results(request, question_id):
    question = get_object_or_404(Question, pk=question_id)
### httpresponse    return HttpResponse(response % question_id)
    return render(request, 'webmain/results.html', {'question':question})
